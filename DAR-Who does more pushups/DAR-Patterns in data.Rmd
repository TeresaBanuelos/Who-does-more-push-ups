...
To find out who does more pushupe between line players and skill players we will analize a ggplot. Then we will look at the numerical results to figure out witch players do more pushups.

# Results
<!--You have both graphical and numerical methods, so you will have both graphical and numerical results to consider.!-->
Based on the data we find that 47.5 percent of skill players do more pushups compared to line players who do 14.5 percent of pushups. Graphically, skill players can do over 100 pushups and line players can do from 30 to 34 pushups.
...
According to this g-gplot line players do about 55% less pushups than skiil players.
```{r}
...
in the results we can see that in average skill players do 55% more pushups that line players
